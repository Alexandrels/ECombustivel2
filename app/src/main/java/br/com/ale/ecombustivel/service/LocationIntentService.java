package br.com.ale.ecombustivel.service;
...
public class LocationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        Location location = intent.getParcelableExtra(LocalizadorEnderecoFragment.LOCATION);
        int type = intent.getIntExtra(LocalizadorEnderecoFragment.TYPE, 1);
        String address = intent.getStringExtra(LocalizadorEnderecoFragment.ADDRESS);
